...
L2 = [8, -2, 3, -6] # <-- same len(L2) == len(list(set(L2))) but L2 != list(set(L2))
...
base = 10
digits = set(range(10))
representation_dict = {x*base*base+y*base+z:[x,y,z] for x in range(base) for y in range(base) for z in range(base)}
